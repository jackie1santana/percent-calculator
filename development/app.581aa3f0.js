...
var givenPercent = function givenPercent() {
  var formInput = document.querySelector("#businessForm");
  var display = document.querySelector("#businessRes");
  formInput.addEventListener("submit", function (e) {
    e.preventDefault();
    var percentValue = e.target[0].value.replace("%", "");
    var amountValue = e.target[1].value.replace(",", "");
    var moneyYouGet = percentValue * 0.01 * amountValue;
    moneyYouGet = moneyYouGet.toFixed(2);
    moneyYouGet = (0, _parseInt2.default)(moneyYouGet).toLocaleString();
    console.log(percentValue);
    console.log(amountValue);
    e.target[0].value = "";
    e.target[1].value = "";
    display.innerHTML = "<br> <br> <p>" + "If the offer is " + percentValue + "% of $" + (0, _parseInt2.default)(amountValue).toLocaleString() + "<br> The amount you will receive: $" + moneyYouGet + "</p>";
  });
}; //Price on Sale


var onSalePercent = function onSalePercent() {
  var formInput = document.querySelector("#onSaleForm");
  var display = document.querySelector("#onSaleRes");
  formInput.addEventListener("submit", function (e) {
    e.preventDefault();
    var wholePrice = e.target[0].value.replace(",", "");
    var salePercent = e.target[1].value.replace("%", "");
    var priceAfterDiscount = (100 - salePercent) * 0.01 * wholePrice;
    var moneySaved = wholePrice - priceAfterDiscount;
    display.innerHTML = "<br> <br> <p>" + "If the item is on sale for " + salePercent + "% and the current price is $" + wholePrice + "<br> Then the item would be: $" + moneySaved.toFixed(2) + "</p>";
    e.target[0].value = "";
    e.target[1].value = "";
  });
}; // 15% Tip for a waiter
...
var tipCalculator = function tipCalculator() {
  var formInput = document.querySelector("#tipForm");
  var display = document.querySelector("#tipRes");
  formInput.addEventListener("submit", function (e) {
    e.preventDefault();
    var amount = e.target[0].value.replace(",", "");
    var tip = 15 * 0.01 * amount;
    var tip2 = 20 * 0.01 * amount;
    display.innerHTML = "<br> <br> <p>" + "15 percent tip would be: $" + tip.toFixed(2) + "<br> 20 percent tip would be: $" + tip2.toFixed(2);
    "</p>";
    e.target[0].value = "";
  });
};
...
onSalePercent();
tipCalculator();
},{"@babel/runtime-corejs2/core-js/parse-int":"../node_modules/@babel/runtime-corejs2/core-js/parse-int.js","./scss/app.scss":"../src/scss/app.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
